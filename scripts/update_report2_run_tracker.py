...
def render() -> str:
    return "\n".join([
        ...
        "",
        "The supported local and SSH production entry point is:",
        "",
        "```bash",
        "scripts/run_report2_local.sh --suite base --methods SIM,DIM",
        "```",
        "",
        "The university CSC entry point accepts the same suites and methods:",
        "",
        "```bash",
        "scripts/run_report2_csc.sh --suite base --methods SIM,DIM --omp-threads 32",
        "```",
        "",
        "Run the three-material and 3D production suites with:",
        "",
        "```bash",
        "scripts/run_report2_local.sh --suite three-material,3d --methods SIM,DIM",
        "```",
        "",
        "Run SIM-only OpenMP scaling with:",
        "",
        "```bash",
